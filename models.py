...
class Product(Model):
    ...
    unit_price = fields.DecimalField(max_digits=8, decimal_places=2, default=0.00)  # Corrected 'max_digits'
    revenue = fields.DecimalField(max_digits=20, decimal_places=2, default=0.00)  # Corrected 'max_digits'
    supplied_by = fields.ForeignKeyField('models.Supplier', related_name="goods")  # Corrected related_name
...
class Supplier(Model):
    ...
    phone = fields.CharField(max_length=15)  # Corrected max_length
